...
public class EntityModelFactoryImpl extends EFactoryImpl implements EntityModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EntityModelPackage.ENTITIES: return createEntities();
			case EntityModelPackage.PRIMITIVE_TYPE: return createPrimitiveType();
			case EntityModelPackage.ENTITY: return createEntity();
			case EntityModelPackage.FIELD: return createField();
			default:
